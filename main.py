...
videoDirectory = os.path.join("C:", "Users", "devonodell", "Desktop", "ImportantProjects", "memefarm1", "videosOutput", f"{num_to_month[now.month].upper()}_{now.year}_V{now.day}")

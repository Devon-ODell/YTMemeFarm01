...
It downloads videos scraped from Instagram profiles followed by a burner Instagram account(login details are located in a config.py file). I should mention this is all in Python. It downloads the video content to a folder within the directory titled "instagramContent". It makes a compilation and uploads this to a separate folder labelled "videosOutput". Using the Google YouTube API, I upload the contents of "videosOutput" once daily, at 6pm. Then I delete the contents of videosOutput; rinse and repeat.
